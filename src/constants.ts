...
// El número se lee desde variable de entorno para no exponerlo en el bundle.
// En local: añade VITE_WHATSAPP_NUMBER=34661226784 a tu .env.local
// En producción: configúralo en las variables de entorno de tu hosting.
