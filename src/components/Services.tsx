...
// Color de fondo suave por servicio al hacer hover
const hoverColors: Record<string, string> = {
  web: 'hover:bg-blue-50',
  apps: 'hover:bg-amber-50',
  automations: 'hover:bg-emerald-50',
  design: 'hover:bg-rose-50',
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {SERVICES.map((service, index) => (
            <motion.div
              ...
              className={`p-8 bg-white border border-earth-900/5 rounded-3xl hover:border-earth-900/10 transition-all duration-300 group ${hoverColors[service.id] ?? ''}`}
            >
