        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <AnimatePresence mode="popLayout">
            {filteredProjects.length > 0 ? (
              ...
              // Estado vacío cuando la categoría no tiene proyectos
              <motion.div
                key="empty"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="col-span-full text-center py-20 text-earth-800/40"
              >
            ...
            >
              ...
              <div className="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto">
                ...
                <div className="space-y-8 mb-10">
                  <div>
                    <h4 className="text-sm font-sans font-bold uppercase tracking-wider text-earth-800 mb-2">
                      Descripción
                    </h4>
                  ...
                  <div>
                    ...
                    <p className="text-earth-800/70 leading-relaxed italic">
