...
// Importa miniaturas de proyectos para el collage visual
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-serif leading-[1.1] mb-6 text-earth-900">
              Soluciones digitales <br />
              <span className="italic">sencillas</span> para emprendedores
            </h1>

            <p className="text-lg md:text-xl text-earth-800/70 mb-10 leading-relaxed">
          ...
          >
            {[proyecto1, auto1, web1, diseno1].map((src, i) => (
              <motion.div
                key={i}
                className={`overflow-hidden rounded-2xl bg-beige-200 ${i === 0 ? 'row-span-2' : ''}`}
              ...
              >
                <img
                  ...
                  alt=""
                  loading="lazy"
                  className={`w-full object-cover ${i === 0 ? 'h-full' : 'h-40'}`}
                />
              </motion.div>
            ))}
          </motion.div>
